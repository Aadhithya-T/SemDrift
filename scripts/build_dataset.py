...
def mutate_doc_negation(docstring, severity="moderate"):
    severity_priority = {
        "mild": [r"\bdefault\b", r"\bvalid\b", r"\balways\b"],
        "moderate": [r"\bcan\b", r"\bshould\b", r"\bmust\b", r"\bwill\b"],
        "severe": [r"\breturns\b", r"\braises\b", r"\bautomatically\b"],
    }

    candidates = severity_priority.get(severity, [])
