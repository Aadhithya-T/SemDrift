...
class SemDriftDataset(Dataset):
    """Loads JSONL records across V1 (synthetic) and V2 (real-world-grounded) schemas."""
...
# Alias for explicit JointEncoderDataset naming
JointEncoderDataset = SemDriftDataset
