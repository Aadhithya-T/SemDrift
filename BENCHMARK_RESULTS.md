...
### Table 2: Complete V1 Synthetic Benchmark (Controlled Test Set, $N = 1,205$)
...
### Table 3: In-Distribution Validation Set Performance
...
## 5. Fine-Grained Performance Breakdowns on V1 Synthetic Test Set
...
## 6. Statistical Significance Tests (McNemar's $\chi^2$ Test)
...
## 7. Artifact Directory & File Manifest
